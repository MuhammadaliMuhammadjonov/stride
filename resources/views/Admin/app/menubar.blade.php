...
<ul class="menu-nav">
    ...
    @foreach ($menuos as $menu)
        <li class="menu-item" aria-haspopup="true">
            <a href="{{route('menu.section', ['id' => $menu->id])}}" class="menu-link">
                <span class="svg-icon svg-icon-primary svg-icon-2x mr-2">
                    <!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Git2.svg-->
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24"/>
                            <rect fill="#000000" opacity="0.3" x="5" y="8" width="2" height="8" rx="1"/>
