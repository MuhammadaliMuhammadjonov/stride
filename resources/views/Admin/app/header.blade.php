...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{asset('')}}admin/plugins/custom/prismjs/prismjs.bundle.css?v=7.0.3" rel="stylesheet" type="text/css" />
		...
		<link href="{{asset('')}}admin/css/themes/layout/aside/dark.css?v=7.0.3" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
